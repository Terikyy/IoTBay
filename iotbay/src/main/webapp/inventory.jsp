            ...
            <div class="centered-container">
                ...
                <div class="product-form">
                    <form action="${pageContext.request.contextPath}/products/inventory" method="post" class="product-grid">
                        ...
                        <input type="date" name="releaseDate" value="<%= dateFormat.format(new java.util.Date()) %>">
                    ...
                    <div class="product-form">
                        <form action="${pageContext.request.contextPath}/products/inventory" method="post" class="product-grid">
                            ...
                            <select name="category">
                                ...
                                <% if (categories != null) { %>
                                    <% for (String category : categories) { %>
                                        <option value="<%= category %>" <%= category.equals(product.getCategory()) ? "selected" : "" %>><%= category %></option>
                                    <% } %>
                                <% } %>
                                <option value="new_category">New Category...</option>
                            </select>
                            ...
                            <div class="action-buttons">
                                ...
                                <button type="submit" class="delete-button" onclick="if(confirm('Are you sure you want to delete this product?')) {this.form.action.value='delete';} else {return false;}">Delete</button>
                            </div>
                        </form>
                    </div>
                <% } } else { %>
